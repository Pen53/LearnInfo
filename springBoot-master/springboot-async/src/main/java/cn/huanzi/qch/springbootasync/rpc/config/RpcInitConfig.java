...
import cn.huanzi.qch.springbootasync.rpc.annotation.RpcClient;
...
public class RpcInitConfig implements ImportBeanDefinitionRegistrar {
    ...
    public void registerBeanDefinitions(AnnotationMetadata importingClassMetadata, BeanDefinitionRegistry registry) {
        ...
        Set<BeanDefinition> beanDefinitionSet = provider.findCandidateComponents("cn.huanzi.qch.springbootasync.rpc");
